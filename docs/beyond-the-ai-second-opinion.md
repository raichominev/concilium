...
Concilium is available through the Claude Code plugin marketplace: add `raichominev/concilium`, then install `concilium@raicho-skills`. Its source and documentation are public in the [Concilium GitHub repository](https://github.com/raichominev/concilium).
